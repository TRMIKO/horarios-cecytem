...
CREATE TABLE TBL_USER(
  ...
  ENM_ESTADO_CIVIL ENUM('SOLTER@','CASAD@','VIUD@','DIVORCIAD@'),
  ...
  ENM_STATUS ENUM('ACTIVO','INACTIVO'),
...
CREATE TABLE TBL_GRUPO(
  ...
  INT_TAMAÑO INT(11) UNSIGNED DEFAULT NULL,
...
CREATE TABLE TBL_MATERIA(
  ...
  INT_HORAR INT(11) UNSIGNED DEFAULT NULL
);
