...
DROP TABLE IF EXISTS TBL_GENERACION;
...
CREATE TABLE TBL_PDF(
  INT_PDF INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  VCH_NOMBRE VARCHAR(45) DEFAULT NULL,
  VCH_VALOR VARCHAR(45) DEFAULT NULL
);
...
CREATE TABLE TBL_USER(
  ...
  ENM_ESTADO_CIVIL ENUM('Soltero(a)','Casado(a)','Viudo(a)','Divorciado(a)') DEFAULT 'Soltero(a)',
...
CREATE TABLE TBL_MATERIA(
  ...
  VCH_NOMBRE VARCHAR(245) DEFAULT NULL,
...
CREATE TABLE TBL_GENERACION(
  INT_GENERACION INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  VCH_NOMBRE VARCHAR(245) DEFAULT NULL
);
CREATE TABLE TBL_HORARIO(
  ...
  INT_GENERACION INT(11) UNSIGNED NOT NULL,
  VCH_HORARIO VARCHAR(45) DEFAULT NULL,
  INT_DIA INT(11) DEFAULT NULL,
  TXT_JSON TEXT DEFAULT NULL,
  FOREIGN KEY (INT_PROFESOR) REFERENCES TBL_USER(INT_USER),
  FOREIGN KEY (INT_GENERACION) REFERENCES TBL_GENERACION(INT_GENERACION),
